...
qrcode.decode = function(src,color){
        ...
        image.onload=function(){
            ...
            try
            {
                qrcode.result = qrcode.process(context,color);
            }
            catch(e)
            {
				qrcode.result = null;
            }
            if(qrcode.callback!=null && qrcode.result != null)
                qrcode.callback(qrcode.result,color);
        }
        image.src = src;
}
